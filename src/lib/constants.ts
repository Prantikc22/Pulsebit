...
export const AUTH_TOKEN = 'pulsebit.auth';
export const LOCALE_CONFIG = 'pulsebit.locale';
export const TIMEZONE_CONFIG = 'pulsebit.timezone';
export const DATE_RANGE_CONFIG = 'pulsebit.date-range';
export const THEME_CONFIG = 'pulsebit.theme';
export const DASHBOARD_CONFIG = 'pulsebit.dashboard';
export const VERSION_CHECK = 'pulsebit.version-check';
export const SHARE_TOKEN_HEADER = 'x-pulsebit-share-token';
export const HOMEPAGE_URL = 'https://pulsebit.com';
export const REPO_URL = 'https://github.com/newuser/pulsebit';
export const UPDATES_URL = 'https://api.pulsebit.com/v1/updates';
export const TELEMETRY_PIXEL = 'https://i.pulsebit.com/a.png';
